...
Una prima problematica è stata in generale la scarsa documentazione riscontrata. I connettori ad hoc per i vari sistemi sono scritti e pubblicati da entità diverse che curano in maniera differente (a seconda anche degli interessi che hanno) la relativa documentazione. Se il connettore verso MongoDB non ha dato particolari problemi, non si può dire lo stesso per quello da MQTT. In una prima istanza si è provato ad utilizzare ilo connettore scritto da confluent senza troppa fortuna. Dopo vari tentativi si è deciso di cambiare connettore che ha dato risultati migliori a fronte anche di una migliore documentazione.
